          ...
          <div className="shrink-0 self-start sm:self-auto pt-1 sm:pt-2 md:pt-3 flex flex-wrap gap-3">
            {project.playStoreUrl && (
              <a
                ...
                className="inline-flex items-center justify-center rounded-full border border-white/20 bg-white/10 px-4 py-2.5 text-xs font-semibold uppercase tracking-[0.1em] text-white backdrop-blur-md transition hover:bg-white/20 hover:scale-[1.03] gap-2"
              >
                <svg className="w-4 h-4 shrink-0" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="relative flex items-center justify-center min-h-[350px] md:min-h-0 py-2">
            ...
            <div className="group relative w-auto h-full max-h-[100%] aspect-[9/19] rounded-[36px] transition-all duration-500 hover:scale-[1.03] hover:shadow-[0_20px_50px_rgba(215,226,234,0.15)]">
              ...
              >
                ...
                <div className="absolute top-2.5 left-1/2 -translate-x-1/2 w-16 h-3.5 bg-black rounded-full z-30 flex items-center justify-end px-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-[#111] border border-white/5" />
                </div>
                
                {/* Speaker Ear Piece */}
                <div className="absolute top-1 left-1/2 -translate-x-1/2 w-8 h-1 bg-neutral-900 rounded-full z-30" />
                ...
                <div className="h-6 w-full bg-black/40 backdrop-blur-sm z-20 absolute top-0 left-0 flex items-center justify-between px-4 text-[8px] font-medium text-white/80 select-none">
                  ...
                  <div className="flex items-center gap-1">
                    <svg className="w-2.5 h-2.5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 3c-1.2 0-2.4.4-3.4 1.2L2.3 9.4c-.9.7-.9 2 0 2.8l1.1 1.1c.7.7 2 .7 2.8 0l2.2-2.2v8.9c0 1.1.9 2 2 2h3.2c1.1 0 2-.9 2-2v-8.9l2.2 2.2c.7.7 2 .7 2.8 0l1.1-1.1c.7-.7.7-2 0-2.8l-6.3-5.2C14.4 3.4 13.2 3 12 3z" />
                    </svg>
                    <div className="w-3.5 h-2 border border-white/60 rounded-[3px] p-[1px] flex items-center">
