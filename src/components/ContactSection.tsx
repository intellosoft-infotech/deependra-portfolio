...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'satyampatelbankhedi@gmail.com',
    href: 'mailto:satyampatelbankhedi@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'Phone',
    ...
    href: 'tel:+919174204019',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/deependra-patel-57b0ba266',
    href: 'https://linkedin.com/in/deependra-patel-57b0ba266',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@deependr20',
    href: 'https://github.com/deependr20',
  },
];
